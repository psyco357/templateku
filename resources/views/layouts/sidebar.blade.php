...
<aside id="sidebar"
    class="fixed top-0 left-0 z-[70] flex h-screen flex-col border-r border-gray-200 bg-white px-5 text-gray-900 transition-all duration-300 ease-in-out dark:border-gray-800 dark:bg-gray-900 xl:z-40"
    x-data="{
        openSubmenus: {},
        init() {
                ...
                @foreach ($menuGroup['items'] as $itemIndex => $item)
                    @if (isset($item['subItems']))
                        ...
                        @foreach ($item['subItems'] as $subItem)
                            if (this.isPathMatch('{{ $subItem['path'] }}')) {
    ...
    <div class="pt-8 pb-7 flex"
        ...
        <a href="/" wire:navigate>
            <div x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen"
                ...
                <x-logo.app-logo class="h-10 w-10 text-orange-500 dark:text-orange-400" />
                <div class="flex flex-col leading-none">
                    <span class="text-xs font-semibold uppercase tracking-wide text-orange-500 dark:text-orange-400">Koperasi</span>
                    <span class="text-xl font-bold text-orange-500 dark:text-orange-400">Laravel</span>
                </div>
            </div>
                                ...
                                <ul class="mt-2 space-y-1 ml-9">
                                    ...
                                    <li>
                                        <a href="{{ $subItem['path'] }}" wire:navigate
                                            ...
                                            <span
                                                class="w-5 h-5 flex-shrink-0 inline-flex items-center justify-center">
