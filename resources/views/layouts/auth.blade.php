...
<body class="min-h-screen lg:h-screen lg:overflow-hidden" x-data="{ 'loaded': true}" x-init="$store.sidebar.isExpanded = window.innerWidth >= 1280;
const checkMobile = () => {
...
<div
    ...
    data-status-title="{{ session('status_type') === 'info' ? 'Informasi' : 'Berhasil' }}"
    data-status-color="{{ session('status_type') === 'info' ? '#2563eb' : '#16a34a' }}"></div>
<script>
