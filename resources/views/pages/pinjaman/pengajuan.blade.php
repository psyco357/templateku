...
<div class="space-y-6"
    ...
    <div class="grid gap-6 xl:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p class="mt-1 text-sm text-slate-500">Daftar pinjaman yang sudah tercatat di koperasi.</p>
                ...
                <table class="min-w-full divide-y divide-slate-200 text-sm">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr>
                            ...
                            <td class="py-3 pr-4 text-slate-600">{{ $item->first_due_date?->translatedFormat('d M Y') }}<br><span class="text-xs text-slate-400">akhir {{ $item->final_due_date?->translatedFormat('d M Y') }}</span></td>
                            <td class="py-3 pr-4">
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="py-6 text-center text-slate-500">Belum ada pinjaman yang tercatat.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
