        ...
        <div class="register-form-panel relative z-10 w-full bg-white dark:bg-gray-900 lg:fixed lg:inset-y-0 lg:left-0 lg:h-screen lg:w-1/2 lg:overflow-y-auto duration-300 ease-linear no-scrollbar">
            <div class="mx-auto w-full max-w-md pt-20 pb-10 px-6">
                <div class="text-center mb-8">
                    <h1 class="text-3xl font-bold text-zinc-900 dark:text-white mb-2">Lupa Password</h1>
                    <p class="text-zinc-600 dark:text-zinc-400">Masukkan email akun Anda untuk menerima link reset password.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
                    ...
                    <div class="pt-2 text-sm text-center">
                        <a href="{{ route('login') }}" class="text-orange-600 dark:text-orange-400 hover:underline">
                            Kembali ke login
                        </a>
                    </div>
                </form>
